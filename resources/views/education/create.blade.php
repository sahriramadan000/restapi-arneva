                ...
                <div class="card-body">
                    <div class="col-12 col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="religion_name" value="{{ old('religion_name') }}" class="form-control border border-secondary px-3" placeholder="Ex: Islam" id="religion_name" aria-describedby="religion_name">
                        </div>
                    </div>
                </div>
